...
def main(
    ...
    base_model: str = "/storage_fast/rhshui/llm/llama_hf/7B/",
    lora_weights: str = "./model/game/1_2048_influence_sorted",
    test_data_path: str = "data/game/test/test.json",
    result_json_data: str = "results/game_2048_influence_sorted.json",
    batch_size: int=2,
):
    assert (
        base_model
